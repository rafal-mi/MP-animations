...
import org.pinczow.animations.animations.Animation14
import org.pinczow.animations.animations.Animation15
    ...
    override val animations: List<Animation>
        get() = listOf(
            ...
            Animation(
                ...
                implementation = { Animation14() }
            ),
            Animation(
                id = 15L,
                name = "Animation 15",
                description = "Description 15",
                implementation = { Animation15() }
            ),
        )
}